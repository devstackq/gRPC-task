...
func request_ApiService_InfoByINN_0(ctx context.Context, marshaler runtime.Marshaler, client ApiServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.InfoByINN(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func RegisterApiServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ApiServiceClient) error {
	...
	mux.Handle("POST", pattern_ApiService_InfoByINN_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ApiService_InfoByINN_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_ApiService_InfoByINN_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_ApiService_InfoByINN_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"info"}, ""))
)

var (
	forward_ApiService_InfoByINN_0 = runtime.ForwardResponseMessage
)
